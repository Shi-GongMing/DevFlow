...
from devflow.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from devflow.tools.edit_file import EditFile
    from devflow.tools.file_state_cache import FileStateCache
    from devflow.tools.glob import Glob
    from devflow.tools.grep import Grep
