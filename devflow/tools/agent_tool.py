...
if TYPE_CHECKING:
    from devflow.agent import Agent
    ...
    from devflow.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from devflow.agents.fork import ForkError, build_forked_messages
        from devflow.agents.parser import AgentDef
        from devflow.agents.tool_filter import resolve_agent_tools
        from devflow.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from devflow.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from devflow.agents.fork import ForkError, build_forked_messages
        from devflow.agents.parser import AgentDef
        from devflow.agents.tool_filter import build_teammate_tools
        from devflow.agent import Agent as AgentClass
        from devflow.conversation import ConversationManager
        from devflow.permissions import (
            DangerousCommandDetector,
        ...
        from devflow.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from devflow.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from devflow.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from devflow.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from devflow.client import create_client
