...
from devflow.skills.parser import SkillDef, substitute_arguments
from devflow.tools import ToolRegistry

if TYPE_CHECKING:
    from devflow.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from devflow.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
