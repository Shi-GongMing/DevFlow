...
from devflow.skills.parser import SkillDef, SkillParseError, VALID_NAME_RE, parse_frontmatter, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".devflow/skills"
USER_SKILLS_DIR = "~/.devflow/skills"
...
class SkillLoader:
    ...
    def _load_builtins(self) -> list[SkillDef]:
        results: list[SkillDef] = []
        builtins_pkg = importlib.resources.files("devflow.skills.builtins")
        ...
        for resource in builtins_pkg.iterdir():
            ...
            try:
                ...
                from devflow.skills.parser import _validate_meta
