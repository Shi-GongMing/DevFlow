...
from devflow.teams.backend_detect import BackendDetectionError, detect_backend
from devflow.teams.mailbox import Mailbox, create_message
...
from devflow.teams.progress import TeammateProgress
from devflow.teams.registry import AgentNameRegistry
from devflow.teams.shared_task import SharedTaskStore
from devflow.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from devflow.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
