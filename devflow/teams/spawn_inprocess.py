...
from devflow.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from devflow.agent import Agent
    from devflow.conversation import ConversationManager
    from devflow.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from devflow.conversation import ConversationManager as CM
                conv = CM()
