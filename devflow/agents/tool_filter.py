...
def build_teammate_tools(
    ...
    from devflow.tools.send_message import SendMessageTool
    from devflow.tools.task_create import TaskCreateTool
    from devflow.tools.task_get import TaskGetTool
    from devflow.tools.task_list import TaskListTool
    from devflow.tools.task_update import TaskUpdateTool
