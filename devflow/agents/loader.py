...
PROJECT_AGENTS_DIR = ".devflow/agents"
USER_AGENTS_DIR = "~/.devflow/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("devflow.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from devflow.agents.parser import parse_frontmatter, _validate_agent_meta
