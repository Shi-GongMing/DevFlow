...
from devflow.serialization import build_messages
...
SESSION_SUBDIR = ".devflow/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from devflow.tools.base import StreamEnd, StreamEvent, TextDelta
